                        ...
                        <div class="col-md-4">
                            <div class="card text-white bg-primary mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Add, edit, and delete menu items</p>
                                    <a href="{{ route('admin.menu') }}" class="btn btn-light">Go to Menu</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card text-white bg-success mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Manage food and drink categories</p>
                                    <a href="{{ route('admin.categories') }}" class="btn btn-light">Go to Categories</a>
                                </div>
                            </div>
                        </div>
